...
class BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { role: @banner.role, scroll: @banner.scroll, status: @banner.status, url: @banner.url }
    end
  ...
  test "should update banner" do
    patch :update, id: @banner, banner: { role: @banner.role, scroll: @banner.scroll, status: @banner.status, url: @banner.url }
    assert_redirected_to banner_path(assigns(:banner))
  end
